...
async function getpokenome(){
  const response = await fetch('https://api-pub.bitfinex.com/v2/conf/pub:list:currency')
      return response.json()
  }
  
  getpokenome().then(data=> console.log(data))  
...
const App = () => {
  ...
  return (
    <View style={styles.centeredView}>
      ...
      >
        <View style={styles.centeredView}>
          <View style={styles.modalView}>
            <Text style={styles.modalText}>Consulte uma moeda</Text>
      ...
      >
        <Text style={styles.textStyle}>Mostrar lista</Text>
      </Pressable>
    </View>
  );
};
